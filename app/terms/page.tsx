...
export const metadata = {
  title: 'Terms of Service | Classic Biryani Kabab & Curry',
  description: 'Read the terms of service governing restaurant dine-in, takeaway, online ordering, and catering event deposits.',
};
